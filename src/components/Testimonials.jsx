			...
			<div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10 max-w-screen-xl">
				{clientes &&
					clientes.map((cliente) => (
						...
						>
							<div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-backblue-200 ">
							...
							<div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-resalted-100 text-white">
								<img
									src={cliente.img}
									alt={cliente.name}
